...
class PostCommentsTest < ApplicationSystemTestCase
  ...
  test "should create post comment" do
    ...
    fill_in "Commentable", with: @post_comment.commentable_id
    fill_in "Commentable type", with: @post_comment.commentable_type
    fill_in "Content", with: @post_comment.content
    fill_in "Integer", with: @post_comment.integer
