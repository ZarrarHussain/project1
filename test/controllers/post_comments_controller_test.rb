...
class PostCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_comment" do
    assert_difference("PostComment.count") do
      post post_comments_url, params: { post_comment: { commentable_id: @post_comment.commentable_id, commentable_type: @post_comment.commentable_type, content: @post_comment.content, integer: @post_comment.integer } }
    end
  ...
  test "should update post_comment" do
    patch post_comment_url(@post_comment), params: { post_comment: { commentable_id: @post_comment.commentable_id, commentable_type: @post_comment.commentable_type, content: @post_comment.content, integer: @post_comment.integer } }
